...
<Window xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation'
  ...
  <Border CornerRadius='12' BorderBrush='#FF2DFF20' BorderThickness='4' Margin='10' >
	<StackPanel Margin='10'>
      <TextBlock Text='Laptop Powered Up!' 
                 Foreground='#FF2DFF20' FontSize='28' FontWeight='Bold'
                 TextAlignment='Center' Margin='10'/>
      <TextBlock Text='Disconnect your charger.' 
